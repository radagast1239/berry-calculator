          ...
          <section className="crop-block guide-block">
            ...
            <details className="agronomist-guide">
              ...
              <ul className="guide-list">
                ...
                <li>
                  <strong>НСД, цикл / установление / оборот (мес):</strong> цикл 6–7,5–9 — плодоношение на полке; установление 4–5–6 — рассада до постановки (календарь); оборот 4–5–6
          ...
          <section className="chart-card" id="pdf-sec-chart-dn-profile">
            ...
            <p className="hint chart-footnote">
              {state.dnManualProfileEnabled
                ...
                : `Цикл плодоношения ~${formatValue(dnProfileAxis.cycleMonths, 1)} мес: 1-я и 2-я волны (гауссовы пики), между ними сниженный, но ненулевой сбор. Установление ${formatValue(dnProfileAxis.establish, 1)} мес — сдвиг когорты на календаре, не «пустые» месяцы здесь.`}
            </p>
          </section>
          )}
        </section>
