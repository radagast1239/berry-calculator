...
export const FIELD_HINTS: Record<string, string> = {
  ...
  packout: 'Доля товарной ягоды: какая часть биологического урожая идёт в продажу (0…1), а не в отход. Задаётся отдельно для Мин / Средний / Макс.',
  sdYield: 'Сколько килограммов ВАЛОВОЙ ягоды даёт одно растение за один цикл КСД. Из грамм: делите на 1000 (600 г → 0,6 кг).',
  sdCycle: 'Полный цикл КСД в месяцах (плодоношение ~6 нед + оборот). Число циклов в год = 12 / длина цикла.',
  dnYield:
    'ВАЛОВЫЙ выход с куста за один цикл НСД. «Условный год» агронома (8–9 мес плодоношения) ≈ один цикл при длине 6–9 мес.',
  dnCycle: 'Длительность цикла НСД в месяцах. Вместе с оборотом задаёт число циклов в календарный год.',
  dnTurnaround:
    'Пауза между циклами НСД (зимовка, смена куста). Пауза между волнами внутри цикла моделируется долями волн.',
}
