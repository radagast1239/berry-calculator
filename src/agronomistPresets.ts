...
> = {
  ...
  dnCycleMonths: { min: 6, avg: 7, max: 9 },
  dnEstablishMonths: { min: 4, avg: 5, max: 6 },
  /** Пауза между циклами (зимовка / смена), не между волнами внутри цикла. */
  dnTurnaroundMonths: { min: 4, avg: 5, max: 6 },
  /** Планировать 2 волны; 3 — только для редких сортов (макс). */
  dnWaves: { min: 2, avg: 2, max: 3 },
  /** 2 волны: ~35/65; 3 волны (макс): 20/50/30 через доли 1-й и 2-й. */
